...
public class SSLSocketFactoryCompat extends SSLSocketFactory {
    ...
    public static final X509TrustManager trustAllCert = new X509TrustManager() {@Override
    ...
    static {
        try {
            ...
            if (socket != null) {
                ...
                for (String protocol: socket.getSupportedProtocols()) if (!protocol.toUpperCase()
                    .contains("SSL")) protocols.add(protocol);
